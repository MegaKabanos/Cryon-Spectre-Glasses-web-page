...
const Hero = () => {
  ...
  return (
    <section className="flex flex-col items-center bg-gradient-to-tl from-[#D2D6D9] to-[#25465D] pt-25 sm:pt-10">
      {/* Heading */}
      <motion.h1
        initial={{ opacity: 0, y: -30 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 1.2, delay: 0.7 }}
        className="font-bebas mt-10 sm:mt-19 text-6xl font-bold tracking-wide mb-10 sm:mb-0 text-(--text) md:text-9xl"
      >
      ...
      >
        ...
        <div className="flex items-center justify-center border border-(--border)/20 bg-white/10 w-full backdrop-blur-2xl mb-16 shadow-[0_0_50px_1px_rgba(0,0,0,0.3)]">
